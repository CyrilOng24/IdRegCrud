...
<div class="content update">
	...
	<table>
		...
		<input type="text" name="id_no" placeholder="5442" value="auto" id="id_no">
        <input type="text" name="F_name" placeholder="Cyril" id="F_name">
		
		<label for="M_name">Middle Name</label>
		<label for="L_name">Last Name</label>
		<input type="text" name="M_name" placeholder="Bautista" id="M_name">
		<input type="text" name="L_name" placeholder="Ong" id="L_name">
		
		<label for="email">Email</label>
		<label for="phone">Phone</label>	
		<input type="text" name="email" placeholder="ongcyril24@gmail.com" id="email">
        <input type="text" name="phone" placeholder="092061" id="phone">
